...
const Contact = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Fill in with your Thoughts</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">And you will not feel like an old cardigan.</p>
    </div>
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full">
          <div className="relative">
            <label id="message" className="leading-7 text-sm text-gray-600">Suggestion</label>
